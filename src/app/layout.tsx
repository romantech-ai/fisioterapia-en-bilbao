  ...
  return (
    <html lang="es">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `window.__WIDGET_API_URL="https://automatizacion-webs.vercel.app";window.__PROJECT_ID="fisioterapia-en-bilbao";` }} />

        <script
          src="https://automatizacion-webs.vercel.app/widget.js"
          data-project-name="Fisioterapia en Bilbao Alberphysio"
          data-api-url="https://automatizacion-webs.vercel.app"
          data-project-id="fisioterapia-en-bilbao"
          data-primary-color="#f9d56e"
          defer
        ></script>
      </head>
      <body className="font-sans">
        ...
        <script dangerouslySetInnerHTML={{ __html: `
          (function(){
            ...
            var pid="fisioterapia-en-bilbao";
